...
<script type="text/javascript" src="/blog/Public/Js/Repassword/repassword.js" ></script>
<link href="/blog/Public/Css/jquery-ui.css" rel="stylesheet" type="text/css" />
<link href="/blog/Public/Css/Repassword/repassword.css" rel="stylesheet" type="text/css" />
...
<div id="default-quit">
	...
	<div id="choose">
		...
		<div id="repassword">
			<div class="Rebody">
				<form action="/blog/index.php/Home/Repassword/modify" method="post" name="myform"  >
					<div class="Npassword">
						<label for="Npassword" class="labelsize passlabel"></label>
						<input type="password" name="Npassword" placeholder="新的密码" title="请输入新的密码" tabindex="1"/>
					</div>
					<div class="Npassword2">
						<label for="Npassword2" class="labelsize repasslabel"></label>
						<input type="password" name="Npassword2" placeholder="再输一次" title="请再确认一次" tabindex="2"/>
					</div>
					<div class="operation">
						<button type="button" class="btn" name="ensure" />确定</button>
						<button type="button" class="btn" name="cancle" />重置</button>
					</div>
				</form>	
			</div>	
		</div>
